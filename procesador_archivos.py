...
class ProcesadorArchivosSimple:
    ...
    API_URL = "http://127.0.0.1:8080/receive_file"
    ...
    def dividir_y_guardar(self):
        ...
        for i in range(0, total_filas, self.FILAS_POR_ARCHIVO):
            ...
            parte.to_json(archivo_salida, orient='records', lines=False)
            print(f"Archivo guardado: {archivo_salida}")

            # Enviar el archivo a la API
            self.enviar_a_api(archivo_salida)
